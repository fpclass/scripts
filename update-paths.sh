...
find /modules/cs141/.stack/snapshots/x86_64-linux/lts-14.12/8.6.5/pkgdb/ -type f -name "*.conf" | xargs sed -i 's/\/dcs\/acad\/u1672682/\/modules\/cs141/g'
...
rm /modules/cs141/.stack/snapshots/x86_64-linux/lts-14.12/8.6.5/pkgdb/package.cache
...
stack exec --resolver=lts-14.12 -- ghc-pkg --package-db /modules/cs141/.stack/snapshots/x86_64-linux/lts-14.12/8.6.5/pkgdb/ recache
